 ...
 */
final class Version20211203162325 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ban DROP FOREIGN KEY FK_62FED0E5FA7FD7EB');
        ...
        $this->addSql('ALTER TABLE pick DROP FOREIGN KEY FK_99CD0F9BFA7FD7EB');
